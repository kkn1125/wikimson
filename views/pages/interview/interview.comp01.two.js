...
1차와 다르게 질문과 말하는 어조로 보아 압박면접의 느낌이었습니다.

이 또한 다대다의 면접으로 심지어 면접관, 지원자가 1명씩 더 추가되어 진행됐습니다. 이번에는 임원 면접이기에 회사에 대해 물어볼 것을 대비해 회사 공부를 열심히 했지만 거의 기술면접과 유사했습니다.
...
현재 역량으로는 매우 부족하다는 현실을 다시 알려주었고, 흐지부지하던 JPA공부와 TDD를 먼저 정리해야겠다는 생각이 들었습니다.

코딩을 하면서 클린 코드를 어떻게 짜면 좋을지에 대한 생각과 노력을 했지만 정작 그에 대해서는 아무 언급하지 못하고 어필을 못 한 게 너무 아쉬우면서도 말하지 못했다는 게 심도 있게 다루지 않았기에 그 말이 차마 나오지 못한 것 같아 많은 생각이 듭니다.
